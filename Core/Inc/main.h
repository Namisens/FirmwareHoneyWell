...
/* Private defines -----------------------------------------------------------*/
#define MUX_1_Pin GPIO_PIN_9
#define MUX_1_GPIO_Port GPIOB
#define MUX_4_Pin GPIO_PIN_0
#define MUX_4_GPIO_Port GPIOA
#define MUX_3_Pin GPIO_PIN_1
...
#define CHIP_SELECT_FLASH_Pin GPIO_PIN_0
#define CHIP_SELECT_FLASH_GPIO_Port GPIOB
